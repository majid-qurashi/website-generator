...
export const PRESETS: Record<string, PresetTheme> = {
  'modern-blue': {
    id: 'modern-blue',
    name: 'Academic Blue',
    description: 'Clean professionalism with vibrant royal blue accents and crisp typography.',
    colors: {
      primary: '#1e40af',
      primaryHover: '#1d4ed8',
      secondary: '#3b82f6',
  ...
  'green-campus': {
    id: 'green-campus',
    name: 'Green Campus',
    description: 'Academic forest greens coupled with natural warm backgrounds and elegant cards.',
    colors: {
      primary: '#0f5132',
      primaryHover: '#146c43',
      secondary: '#198754',
  ...
  'minimal-white': {
    id: 'minimal-white',
    name: 'Minimal Mono',
    description: 'Sleek monochrome gray & white layout with high contrast sharp typography.',
    colors: {
      primary: '#18181b',
      primaryHover: '#27272a',
      secondary: '#71717a',
  ...
  'glassmorphism': {
    id: 'glassmorphism',
    name: 'Glassmorphism',
    description: 'Modern translucent cards with backdrop-blur, subtle gradients, and floating effects.',
    colors: {
      primary: '#4f46e5',
      primaryHover: '#4338ca',
      secondary: '#db2777',
  ...
  'dark-neon': {
    id: 'dark-neon',
    name: 'Dark Premium',
    description: 'Immersive dark SaaS-style mode with neon blue & violet gradients and smooth scales.',
    colors: {
      primary: '#3b82f6',
      primaryHover: '#60a5fa',
      secondary: '#8b5cf6',
  ...
  'luxury-gold': {
    id: 'luxury-gold',
    name: 'Luxury Gold',
    description: 'Elite royal gold accents with rich slate contrasts and elegant serif typography.',
    colors: {
      primary: '#854d0e',
      primaryHover: '#a16207',
      secondary: '#1e293b',
